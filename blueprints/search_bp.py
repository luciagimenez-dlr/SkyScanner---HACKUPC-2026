...
PLAN_PROMPT = """\
You are WanderLens AI, an expert and empathetic travel planner.
...
{{
  ...
  "sustainability_tips": ["One sustainability tip"],
  "days": [
    {{
      "day": 1,
...
def generate_plan():
    print(f"API key present: {bool(_gemini_api_key)}")
    print(f"Model loaded: {gemini_model is not None}")
